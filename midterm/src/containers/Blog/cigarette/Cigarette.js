...
export default class Posts extends Component {
    ...
    test = url => {
        ...
        axios.get("http://localhost:4000/cigarette").then(data =>
    ...
    test3 = () => {
        ...
        axios.post('http://localhost:4000/cigarette', newurl)
    ...
    render() {
        ...
        const lists = [< div >< div > {
            this.state.show.map(numbers => < span >< iframe width="150"
                ...
                <NavLink to={"/cigarette/" + postIDs[numbers]} class="newbut"> MORE </NavLink></span >)}
            <br></br>
